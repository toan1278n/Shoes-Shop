<?php
  ...
  WHERE b.name_brand = 'Nike' ORDER BY price $sort ";
...
.btn:hover::after, .btn:hover::before {
 ...
 <section class="home-section">
    <div class="home-content">
      ...
      <div style="margin-left:500px; font-size: 60px; font-family:'Brush Script MT', Times, serif; font-weight:bold;">Nike <img src="img/lg_nike.png" width="60px" height="60px" style="margin-top: 30px;"></img> </div>
      <a href="nike.php?sort=desc" style="margin-left: 500px; color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-sort-down" viewBox="0 0 16 16">
      <path d="M3.5 2.5a.5.5 0 0 0-1 0v8.793l-1.146-1.147a.5.5 0 0 0-.708.708l2 1.999.007.007a.497.497 0 0 0 .7-.006l2-2a.5.5 0 0 0-.707-.708L3.5 11.293V2.5zm3.5 1a.5.5 0 0 1 .5-.5h7a.5.5 0 0 1 0 1h-7a.5.5 0 0 1-.5-.5zM7.5 6a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zm0 3a.5.5 0 0 0 0 1h3a.5.5 0 0 0 0-1h-3zm0 3a.5.5 0 0 0 0 1h1a.5.5 0 0 0 0-1h-1z"/>
      </svg></a>
      <a href="nike.php?sort=asc" style="color: black;"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-sort-up" viewBox="0 0 16 16">
    ...
    <?php  $count = 0;
      ...
      <div class="card ">
        ...
        <div>
        <a target="_blank" href="product-detail.php?id=<?php echo $row['id_product'] ?>">
        <button class="btn">
              DETAILS
        </button>
        </a>
