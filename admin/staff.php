<?php
 ...
 $sql = "SELECT * FROM staff INNER JOIN authorized as a ON a.id_author = staff.id_author";
...
<style>
  ...
  <div class="menu">
  <h2 style="color: white;">Staff's List</h2>
  <a href="add_new_staff.php"  style="text-decoration-line: none;">
  <button type="button" class="button_4" style="margin-left: 100px; margin-top: 50px; background-image: linear-gradient(25deg, #d64c7f, #ee4758 50%);">
  ...
  <td><?php echo $staff["id_staff"]; ?></td>
       ...
       <td><?php echo $staff["email"]; ?></td>
        <td><?php echo $staff["name_author"]; ?></td>
        <td><?php echo $staff["status"]; ?></td>
        
        <td>

        <div style="margin-left: 100px;"><a href='delete-staff.php?id_staff=<?php echo $staff['id_staff'] ?>'>
                    ...
                    <div style="margin-left: 100px; margin-top:10px;"><a href='edit-staff.php?id_staff=<?php echo $staff['id_staff'] ?>'>
